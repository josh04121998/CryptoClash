...
- **Grey is a costume, not a light source.** Normies' `#a3a3a3` describes their *clothes*; their lighting should be warm ordinary office light against the cool neon chaos behind them. Briefing "grey accent lighting" produced a faction of desaturated, rain-soaked, miserable-looking people (average saturation 68 against 126–188 for every other faction) — "plain and unremarkable" was never meant to read as "sad".
