...
One reusable frame/border shell per rarity, no card-specific content — the second rendering pipeline (`tools/card-render/`) composites these behind a card's real art + data-driven text. Generate on a flat background matching the card's real background color in the art-window area (`#0b120e`/`#0e1512`) so it can be composited later without a manual cutout pass. All five: 750×1050 (or a clean multiple), no name, no creature, no card-specific content.

### Common frame (`#9ca3af`)
> An ornate card border/bezel: corner ornaments, a top ticker-badge frame, a name-plate band, and two stat-gem sockets (a hexagon socket for cost/attack, a circle socket for health). Muted silver-grey metal and gem tone (`#9ca3af`), restrained and simple ornamentation befitting the lowest rarity tier. Dark trading-floor/gold-green brand visual language otherwise. Generated on a flat, plain dark background matching the card's own background color (`#0b120e`/`#0e1512`) in the art-window area — no scene, no character, no text, no card name. Portrait 750×1050.

### Uncommon frame (`#22c55e`)
> Same frame structure as the Common tier — corner ornaments, top ticker-badge frame, name-plate band, hexagon cost/attack gem socket, circle health gem socket — but in terminal-green metal/gem tones (`#22c55e`), with slightly more detailed ornamentation than Common. Flat dark background (`#0b120e`/`#0e1512`) in the art-window area, no scene, no text, no card name. Portrait 750×1050.

### Rare frame (`#3b82f6`)
> Same frame structure again, in blue metal/gem tones (`#3b82f6`), with noticeably more ornate metalwork than Uncommon. Flat dark background (`#0b120e`/`#0e1512`) in the art-window area, no scene, no text, no card name. Portrait 750×1050.

### Epic frame (`#a855f7`)
> Same frame structure again, in purple metal/gem tones (`#a855f7`), with elaborate, richly detailed metal and gem work. Flat dark background (`#0b120e`/`#0e1512`) in the art-window area, no scene, no text, no card name. Portrait 750×1050.

### Legendary frame (`#f59e0b`)
> Same frame structure again, in gold metal/gem tones (`#f59e0b`) — the most ornate and precious-looking of the five: heavy gold metalwork, glowing gem sockets, should read as a genuine treasure, the way Hearthstone's own Legendary frame does. Flat dark background (`#0b120e`/`#0e1512`) in the art-window area, no scene, no text, no card name. Portrait 750×1050.
