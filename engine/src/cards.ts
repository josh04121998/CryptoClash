...
export const CARD_POOL: Record<string, CardTemplate> = {
  ...
  ship_it: {
    ...
    health: 1,
    keywords: ["Rush"],
    text: "Rush. Ship it and see what breaks.",
  },
  blueprint: {
    id: "blueprint",
    name: "Blueprint",
  ...
  overleveraged: {
    ...
    attack: 1,
    health: 2,
    text: "Deal 1 damage to yourself. Gain +1 Attack.",
    effects: [
      { trigger: "onPlay", action: { kind: "damage", target: { kind: "selfPlayer" }, amount: 1 } },
      { trigger: "onPlay", action: { kind: "buffSelf", attack: 1 } },
    ],
  },
  slow_burn: {
    id: "slow_burn",
    ...
    rarity: "Common",
    keywords: ["Burn"],
    text: "Deal 1 damage to the enemy player at the end of each turn for 2 turns.",
    effects: [
      { trigger: "onPlay", action: { kind: "burn", target: { kind: "enemyPlayer" }, amountPerTurn: 1, turns: 2 } },
    ],
  },
  margin_call: {
    id: "margin_call",
